...
const gnbData = {
    ...
    연예오락: ["[예정] 골든일레븐: 언리미티드", "[수] 코미디빅리그", "[금] 형따라 마야로 : 아홉 개의 열쇠", "[월] 프리한 닥터", "[수] 명의들의 경고", "[토] 놀라운 토요일", "[화] 벌거벗은 세계사", "[목] 300만 년 전 야생탐험 : 손둥동굴", "[종영] 알쓸별잡", "[수] 유 퀴즈 온 더 블럭", "[목] 70억의 선택", "[종영] 2억 9천 : 결혼전쟁"],
...
// 6. 링크정보 ///////////////////
const linkData = {
    brand: ["브랜드 바로가기", "MNET", "MWAVE", "tvN", "tvN SPORTS", "tvN STORY", "tvN DRAMA", "tvN SHOW", "OCN", "중화TV", "UXN", "CATCHON", "Tooniverse"],
    corp: {
        "CJ 그룹": ["CJ주식회사"],
        "엔터테인먼트 & 미디어": ["CJ ENM 엔터테인먼트부문", "TVING", "CJ CGV"],
        "식품 & 식품 서비스": ["CJ제일제당", "CJ푸드빌", "CJ프레시웨이"],
        "생명공학": ["CJ제일제당 BIO사업부문", "CJ Feed & Care"],
        "물류 & 신유통": ["CJ대한통운", "CJ대한통운 건설부문", "CJ올리브영", "CJ올리브네트웍스", "CJ ENM 커머스부문", "CJ텔레닉스"],
    },
}; ///////////// linkData ///////////////
