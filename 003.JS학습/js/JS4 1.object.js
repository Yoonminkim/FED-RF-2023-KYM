...
kmj_obj.trailer = function () {
 ...
 // 자신만의 오브젝트
 const kimyoonmin_1_obj = {
};

// 오브젝트 형만 만들고 객체내용은 아래에서!
// 1. 영화제목
kimyoonmin_1_obj.title = '인셉션';

// 2. 감독
kimyoonmin_1_obj.director = '크리스토퍼 놀란';

// 3. 배우
kimyoonmin_1_obj.actor = '레오나르도 디카프리오, 조셉 고든 레빗';

// 4. 장르
kimyoonmin_1_obj.genre = '액션';

// 5. 관람가
kimyoonmin_1_obj.ratings = '12';

// 6. 예고편
kimyoonmin_1_obj.trailer = function(){
